...
const Hero = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setDirection(1); // slide left to right
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden text-white font-sans">
      ...
      <div className="relative z-10 container mx-auto px-5 md:px-10 py-12 flex items-center justify-center h-full md:hidden">
        ...
        >
          <h1 className="text-4xl sm:text-5xl font-extrabold bg-clip-text text-transparent bg-red-600 to-red-700 drop-shadow-md">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="mt-8 inline-flex items-center gap-2 bg-red-600 hover:from-yellow-500 hover:to-yellow-700 text-white font-semi-bold text-sm px-6 py-3 rounded-xl shadow-lg transition duration-300"
          >
